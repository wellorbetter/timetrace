...
5. 语气简洁、自然、客观，默认中文。
6. headline 一句话；summary 1–3 句，优先回答“主要用了什么应用、在什么时段、持续多久”；有 activity_timeline 时可引用其中的时间事实。
7. insights 最多 5 条，每条尽量给出具体事实；不要把应用名称扩写成未记录的项目或任务。
8. 如果数据不足，明确说数据不足，不要补全故事。
''';
